...
%load code.sage
︡1179a275-0098-42c4-a8fb-d083a51783c7︡
︠c7203c69-5e8b-43c9-8067-f81a0b9f6a72︠
def f(B):
    v = prime_gap_distribution(B)
    return [v[i] if i<len(v) else 0 for i in [2,4,6,8,252]]
︡db51bbd6-6445-4a6f-b0f3-b2ca50cf3954︡
︠13072bfa-218a-4b8a-a2de-ca7c41312593︠
for B in [10^i for i in [1..8]]:
    print B, f(B)
︡f61dd61c-421f-4f18-9e68-021d1b924a57︡{"stdout":"10 [2, 0, 0, 0, 0]\n100 [8, 7, 7, 1, 0]\n1000 [35, 40, 44, 15, 0]\n10000 [205, 202, 299, 101, 0]\n100000 [1224, 1215, 1940, 773, 0]\n1000000 "}︡{"stdout":"[8169, 8143, 13549, 5569, 0]\n10000000 "}︡{"stdout":"[58980, 58621, 99987, 42352, 0]\n100000000 "}︡{"stdout":"[440312, 440257, 768752, 334180, 0]\n"}︡
